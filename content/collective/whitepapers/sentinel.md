...
17. **Relationship to ContentForest.** ContentForest and Sentinel share enough of their orchestration shape that some of it could be extracted into a shared library. Whether to do that extraction up front, or let Sentinel duplicate the relevant ContentForest patterns until a shared shape emerges naturally, is open. Premature shared library is worse than a small amount of duplication.
